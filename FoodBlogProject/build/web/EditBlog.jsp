                ...
                <div class="layout-page">
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4">Edit post</h4>
                            <div class="row">
                                <div class="col-xxl">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10" style="width:43%">
                                                        <input type="text" class="form-control" id="basic-default-name" 
                                                               name="title" value="${requestScope.blog.getBlogTitle()}" required/>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10" style="width:23%">
                                                        <input type="text" class="form-control" id="basic-default-company" 
                                                               name="author" value="${requestScope.blog.getAuthor()}" required/>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10" style="width:100%">
                                                        <textarea
                                                            ...
                                                            class="form-control" style="height:100px;" value="${requestScope.blog.getContent()}"
                                                            ></textarea>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10" style="width:23%">
                                                        <input name="date" type="date" class="form-control" id="basic-default-company"
                                                               value="${requestScope.blog.getCreatedDate()}" required/>
                                                    </div>
                                                </div>
