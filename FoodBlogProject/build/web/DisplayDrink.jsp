...
<html>
    ...
    <html lang="en">
        ...
        <body>
                            ...
                            <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                                <div class="hero-text">
                                    <div class="hero-text-tablecell">
                                        <h1>Just drink the day away&#127865</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="mainheading">
                            ...
                            <h3 class="section-title">
                                ${requestScope.blog.getBlogTitle()}
                            </h3>
                        </div>
                        <!-- Begin Post Content -->
            ...
            <!--comment-->
            <%@include file="Component/CommentDrink.jsp" %>
            <hr size="8" width="70%" color="red" style="height: 2px;"> 

            <!-- Begin Related-->
        <center>
            <h3 style="margin-top: 40px;">Other drink recipes you may like</h3>
        </center>
        ...
        <div class="graybg">
            <div class="container">
                <div class="row listrecent listrelated">
                    <c:forEach items="${requestScope.drink}" var="d">
                        <div class="col-md-4">
                            <div class="card-about">
                                <center>
                                    <a href="drink?blogid=${d.getBlogID()}">
                                        <img class="img-fluid img-thumb" src="${d.getImage()}">
                                    </a>
                                </center>
                                <div class="card-block">
                                    <h2 class="card-title" style="margin-top:17px;text-align: center;">
                                        <a href="drink?blogid=${d.getBlogID()}">${d.getBlogTitle()}</a>
                                    </h2>
                                    <div class="metafooter">
                                        <div class="wrapfooter">
                                            ...
                                            <span class="author-meta">
                                                <span class="post-name">${d.getAuthor()}</span><br/>
                                                <span class="post-date">${d.getCreatedDate()}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            function deleteBlogDrink(blogid) {
                var c = confirm("Are you sure to delete this Blog ? ")
                if (c) {
                    window.location.href = "deleteBlogDrink?blogid=" + blogid
                }
            }
        </script>
