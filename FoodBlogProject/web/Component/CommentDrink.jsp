    ...
    <div class="container-comment">
        <div class="row">
            <div class="col-sm-5 col-md-6 col-12 pb-4" style="margin-left: 90px;">
                ...
                <c:forEach items="${sessionScope.listComment}" var="c">
                    <div class="comment mt-4 text-justify float-left" style="width:490px"> 
                        ...
                        <p style="margin-bottom:7px;">${c.getContent()}</p>
            ...
            <div class="col-lg-4 col-md-5 col-sm-4 offset-md-1 offset-sm-1 col-12 mt-4"
                ...
                <form id="algin-form" action="drink" method="post">
                    <div class="form-group">
                        <h4>Leave a comment</h4> 
                        <div class="form-group"> 
                            <label for="name">Name</label> <input type="text" name="name" id="fullname" class="form-control" required> 
                        </div>
                        <label for="message">Message</label> 
                        <textarea name="msg" id="" msg cols="30" rows="5" class="form-control" required style="background-color: white;"></textarea>
                    </div>
                    <div class="form-group"> 
