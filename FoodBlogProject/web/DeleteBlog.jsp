...
<html
    ...
    <head>
        ...
        <title>Admin Console - Delete</title>
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.listBlog}" var="b">
                                            <tr>
                                                ...
                                                <td>${b.getAuthor()}</td>
                                                <td>
                                                    <button onclick="deleteBlog(${b.getBlogID()})" style="background-color:purple;color:white;margin-right: 42px;">
                                                        Delete
                                                    </button>
                                                    <button onclick="editBlog(${b.getBlogID()})" style="background-color:red;color:white;">
                                                        Edit
                                                    </button>
                                                </td>
                                            </tr>
